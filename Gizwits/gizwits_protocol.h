...
* @{
*/
#define PRODUCT_KEY "3230d23830be4e4992cb2a8e136e4c4b"
/**@} */
/**@name Product Secret (产品密钥)
* @{
*/
#define PRODUCT_SECRET "ec4b7b308c3543b9b8e4a21b6efb73a5"
/**@} */
...
* @{
*/
#define LOCK_STATUS_BYTEOFFSET                    0
#define LOCK_STATUS_BITOFFSET                     0
#define LOCK_STATUS_LEN                           1
...
/** 用户区设备状态结构体*/
typedef_t struct {
  bool valueLock_status;
} dataPoint_t;

/** 对应协议“4.10 WiFi模组控制设备”中的标志位"attr_flags" */ 
typedef_t struct {
  uint8_t flagLock_status:1;
} attrFlags_t;
